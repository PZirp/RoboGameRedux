...
/**
 * Questa classe rappresenta un oggetto di gioco basilare. Ogni oggetto di gioco
 * deve avere una sua posizione. Inoltre, fornire i metodi update() e render(),
 * che devono essere opportunamente implementati per la sottoclasse che
