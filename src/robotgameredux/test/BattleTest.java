...
public class BattleTest implements IActorManager {
	...
	public static void main(String[] args) {
		...
		AttackRobot testRobotFriend = new AttackRobot(new Coordinates(1, 1), new StandardBattleSystem(tester), null,
				null);
		testRobotFriend.setFaction(Faction.FRIEND);
		testRobotFriend.addWeapon(new Pistol());
		AttackRobot testRobotEnemy = new AttackRobot(new Coordinates(1, 2), new StandardBattleSystem(tester), null,
				null);
		testRobotEnemy.setFaction(Faction.ENEMY);
		AttackRobot testRobotFriend2 = new AttackRobot(new Coordinates(2, 1), new StandardBattleSystem(tester), null,
				null);
