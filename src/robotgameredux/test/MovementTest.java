...
public class MovementTest implements IGameWorld {
	...
	public void movement(AttackRobot testRobot, ActorMovementCommand mc, Coordinates dest) {
		mc = new ActorMovementCommand(testRobot, dest);
