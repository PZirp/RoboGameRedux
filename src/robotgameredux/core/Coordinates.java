...
public final class Coordinates implements Cloneable, Serializable{
	...
	/**
	 * Astrazione che rappresenta una coppia di coordinate su un piano bidimensionale.
	 * <br>Offre metodi per sottrarre e sommare un altro set di coordinate (utili da esempio per calcolare la posizione relativa di due oggetti),
	 * e un metodo per calcolarne la distanza.
	 * <br>L'oggetto è immutabile. 
	 */
