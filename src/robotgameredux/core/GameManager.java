...
public class GameManager implements PropertyChangeListener, Serializable {
	 ...
	 * nessuno dei due giocatori è attivo, ed entrambi hanno mosso, inizia un
	 * nuovo turno, quindi tutti gli attori vengono resettati, insieme ai
	 * controllori. Viene scelto casualmente un controllore che muoverà per
	 ...
	 * se il controllore interattivo è attivo, esamina l'input, se il
	 * controllore gestito dalla CPU è attivo, questo sceglie una mossa. In
